	...
	public PopupView(Context context) {
		...
		if (preview.isVideo() && preview.isTakingPhoto()) {
			...
			String current_iso = sharedPreferences.getString(
					CameraActivityNew.getISOPreferenceKey(), "auto");
					...
					"TEST_ISO", new ButtonOptionsPopupListener() {
						...
						public void onClick(String option) {
							...
							SharedPreferences.Editor editor = sharedPreferences
									.edit();
							editor.putString(
									CameraActivityNew.getISOPreferenceKey(), option);
							editor.apply();
			...
			// popup should only be opened if we have a camera controller, but
			...
			if (preview.getCameraController() != null) {
				...
				addRadioOptionsToPopup(supported_scene_modes, getResources()
						...
						CameraActivityNew.getSceneModePreferenceKey(), preview
								.getCameraController().getDefaultSceneMode(),
						"TEST_SCENE_MODE");
				...
				addRadioOptionsToPopup(supported_color_effects, getResources()
						...
						CameraActivityNew.getColorEffectPreferenceKey(), preview
								.getCameraController().getDefaultColorEffect(),
						"TEST_COLOR_EFFECT");
			}
				...
				checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
					public void onCheckedChanged(CompoundButton buttonView,
						...
						SharedPreferences.Editor editor = sharedPreferences
								.edit();
						editor.putBoolean(
								CameraActivityNew.getAutoStabilisePreferenceKey(),
								isChecked);
						editor.apply();
			...
			addArrayOptionsToPopup(picture_size_strings, getResources()
					...
					picture_size_index, new ArrayOptionsPopupListener() {
						private void update() {
							...
							SharedPreferences.Editor editor = sharedPreferences
									.edit();
							editor.putString(CameraActivityNew
			...
			String timer_value = sharedPreferences.getString(
					CameraActivityNew.getTimerPreferenceKey(), "0");
					...
					new ArrayOptionsPopupListener() {
						private void update() {
							...
							SharedPreferences.Editor editor = sharedPreferences
									.edit();
							editor.putString(
									CameraActivityNew.getTimerPreferenceKey(),
									new_timer_value);
							editor.apply();
						}
