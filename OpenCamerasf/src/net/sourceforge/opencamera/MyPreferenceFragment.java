...
public class MyPreferenceFragment extends PreferenceFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if( widths != null && heights != null ) {
			...
			String resolution_preference_key = CameraActivityNew.getResolutionPreferenceKey(cameraId);
		...
		if( video_quality != null && video_quality_string != null ) {
			...
			lp.setEntries(entries);
			lp.setEntryValues(values);
			String video_quality_preference_key = CameraActivityNew.getVideoQualityPreferenceKey(cameraId);
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                	if( pref.getKey().equals("preference_about") ) {
                		...
                		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(MyPreferenceFragment.this.getActivity());
                		String save_location = sharedPreferences.getString(CameraActivityNew.getSaveLocationPreferenceKey(), "OpenCamera");
                	...
                	if( pref.getKey().equals("preference_reset") ) {
			        	...
			        	.setPositiveButton(R.string.answer_yes, new DialogInterface.OnClickListener() {
					        ...
					        public void onClick(DialogInterface dialog, int which) {
		                		...
		                		editor.clear();
		                		editor.putBoolean(CameraActivityNew.getFirstTimePreferenceKey(), true);
		                		editor.apply();
					        }
			        	})
